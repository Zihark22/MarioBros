...
if [ $# -eq 0 ]; then # aucun paramètre
  ...
  g++ mario.o game.o duree.o map.o personnage.o bloc.o element.o sound.o piege.o user.o objectlance.o mechant.o -o ../exec -lallegro -lallegro_main -lallegro_primitives -lallegro_font -lallegro_image -lallegro_color -lallegro_ttf -lallegro_dialog -lallegro_audio -lallegro_acodec -lallegro_video
  if [ $? -eq 0 ]; then # -ne pour une erreur sur la commande précédente et -eq pour pas d'erreur
    ...
    ./build/exec # execution
  else
    echo "\033[31mCompilation failed !!\033[0m"
  fi
else 
   echo "\033[38;5;208mErreur aucuns paramètres requis : ./compileExecute.sh \033[0m"
fi
